"""
run_A5_router_sweep.py -- Droga A+, blok 1: sweep hiperparametrow routera.

Cel: zamknac luke 2.3pp miedzy ProtoRouter (96.7%) a ORACLE (99%).
Router jest jedynym sufitem systemu -- poprawa routera = poprawa accuracy.
...
Uruchom:
    .venv\\Scripts\\python.exe src\\run_A5_router_sweep.py
"""
...
N_IN = 784
N_OUT = 10
HIDDEN = 24  # pod hidden -- stale, z A2
...
def main():
    ...
    print("=" * 72)
    print("DROGA A+ -- blok 1: sweep hiperparametrow routera")
    ...
    # WNIOSEK
    # ================================================================
    baseline_acc = 0.967  # z A2b
    delta = overall_best_acc - baseline_acc

    print("\n" + "=" * 72)
    print("WNIOSEK")
    print("=" * 72)
    print(f"Baseline (A2b): {baseline_acc*100:.1f}%")
    ...
    out = os.path.join(RESULTS_DIR, "A5_router_sweep.json")
